...
const FileUploader = ({onFileSelect}:FileUploaderProps) => {
    const onDrop = useCallback((acceptedFiles:File[]) => {
        ...
        onFileSelect?.(file) // we are passing it back to the file from the upload prop
  }, [onFileSelect])
...
//   const sizeString = formatSize(1048576); // "1.00 MB"
        ...
        <div className='space-y-4 cursor-pointer'>
            ...
            {file ? (
                <div className='uploader-selected-file' onClick={(e)=>e.stopPropagation()}>
                    <img src='/images/pdf.png' alt='pd' className='size-10' />
                    
                    <div className='flex items-center space-x-3'>
                        <div>
                            <p className='text-lg text-gray-200 font-medium truncate max-xs'>
                                {file.name}
                            </p>
